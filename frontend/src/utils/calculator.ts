...
export function calculateResult(
  ...
  const label = labels.labels.find((l) => l.id === labelId) as PersonalityLabel;
 ...
 * 根据 ID 获取标签详情
 */
export function getLabelById(labelId: string): PersonalityLabel | undefined {
  return labels.labels.find((l) => l.id === labelId);
}
